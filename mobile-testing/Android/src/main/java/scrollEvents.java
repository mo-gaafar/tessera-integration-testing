...
public class scrollEvents {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // events near Cairo
        WebElement eventsNear = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Events Near Cairo Governorate\"]"));
        String eventsNearText = eventsNear.getAttribute("content-desc");
        if(eventsNearText.equals("Events Near Cairo Governorate"))
        {
            System.out.println("Events Near - Text Passed");
        }
        else
        {
            System.out.println("Events Near - Text Failed");
        }
        Thread.sleep(3000);
        // event suggestions
        WebElement eventsULike = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Events We Think You'll Love!\"]"));
        String eventsULikeText = eventsULike.getAttribute("content-desc");
        if(eventsULikeText.equals("Events We Think You'll Love!"))
        {
            System.out.println("Event Suggestions - Text Passed");
        }
        else
        {
            System.out.println("Event Suggestions - Text Failed");
        }
        // first event in page
        WebElement firstEvent = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Anime North 2023\n" +
                "Khan el Khalili \n" +
                "1  JUL\"]"));
        String firstEventText = firstEvent.getAttribute("content-desc");
        if(firstEventText.equals("Anime North 2023\n" +
                "Khan el Khalili \n" +
                "1  JUL"))
        {
            System.out.println("First Event - Text Passed");
        }
        else
        {
            System.out.println("First Event - Text Failed");
        }

        // middle event
        Thread.sleep(6000);
        WebElement middleEvent = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Learn How To Increase your Potential and Push yourself more! FREE EVENT!\n" +
                "Khan el Khalili \n" +
                "24  AUG\"]"));
        String middleEventText = middleEvent.getAttribute("content-desc");
        if(middleEventText.equals("Learn How To Increase your Potential and Push yourself more! FREE EVENT!\n" +
                "Khan el Khalili \n" +
                "24  AUG"))
        {
            System.out.println("Middle Event - Text Passed");
        }
        else
        {
            System.out.println("Middle Event - Text Failed");
        }

        // last event in page
        Thread.sleep(6000);
        WebElement lastEvent = driver.findElement(By.xpath("(//android.widget.ImageView[@content-desc=\"Cross body2\n" +
                "My Venue\n" +
                "1  MAY\"])[5]"));
        String lastEventText = lastEvent.getAttribute("content-desc");
        if(lastEventText.equals("Cross body2\n" +
                "My Venue\n" +
                "1  MAY"))
        {
            System.out.println("Last Event - Text Passed");
        }
        else
        {
            System.out.println("Last Event - Text Failed");
        }
