...
public class freeFilter {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // click the free filter
        WebElement freeFilter = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Free\"]"));
        freeFilter.click();

        // first event after free filter
        Thread.sleep(6000);
        WebElement firstEventFiltered = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[2]"));
        System.out.println("Free Filter Passed");
