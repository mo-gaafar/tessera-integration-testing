...
public class manageAttendees {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // open an event
        WebElement gibberishEvent = driver.findElement(By.xpath("//android.view.View[@content-desc=\"31%, gibberish\n" +
                "2023-05-13T17:16:00.000Z \n" +
                " 4/13\n" +
                "£400\"]"));
        gibberishEvent.click();
        Thread.sleep(5000);

        WebElement manageAttendeesBtn = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Manage Attendees\n" +
                "Manually sell new tickets to attendees.\"]"));
        manageAttendeesBtn.click();
        Thread.sleep(5000);

        WebElement freeRadioBtn = driver.findElement(By.xpath("//android.widget.RadioButton[@content-desc=\"Free\"]"));
        freeRadioBtn.click();
        Thread.sleep(5000);

        WebElement notFreeRadioBtn = driver.findElement(By.xpath("//android.widget.RadioButton[@content-desc=\"Not Free\"]"));
        notFreeRadioBtn.click();
        Thread.sleep(5000);

        WebElement vipPlusBtn = driver.findElement(By.xpath("//android.view.View[@content-desc=\"VIP\n" +
        ...
        WebElement checkBtn = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View[1]/android.widget.Button[2]"));
        checkBtn.click();
        Thread.sleep(5000);

        WebElement clearBtn = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Clear\"]"));
        clearBtn.click();
        Thread.sleep(3000);
