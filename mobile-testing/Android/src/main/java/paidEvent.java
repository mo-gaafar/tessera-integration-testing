...
public class paidEvent {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        WebElement regularBtn = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View[1]/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.RadioButton[1]"));
        regularBtn.click();
        ...
        // check tier info
        WebElement tier = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Tier: Regular\"]"));
        String tierText = tier.getAttribute("content-desc");
        if(tierText.equals("Tier: Regular"))
        {
        ...
        // check price
        WebElement checkoutPrice = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Price: 20\"]"));
        String checkoutPriceText = checkoutPrice.getAttribute("content-desc");
        if(checkoutPriceText.equals("Price: 20"))
        {
