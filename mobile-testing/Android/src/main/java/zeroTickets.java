...
public class zeroTickets {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // check that plus button exists
        WebElement addedTickets = driver.findElement(By.xpath("//android.view.View[@content-desc=\"0\"]"));
        String addedTicketsText = addedTickets.getAttribute("content-desc");
        if(addedTicketsText.equals("0"))
        {
            System.out.println("0 tickets Text Passed");
        }
        else
        {
            System.out.println("0 tickets Text  Failed");
        }

        // check that minus button exists
        ...
        // show that checkout doesn't proceed due to 0 tickets
        WebElement cancelBtn = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Cancel\"]"));
