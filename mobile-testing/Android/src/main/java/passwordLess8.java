...
public class passwordLess8 {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(5000);
        WebElement passwordAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Password must be 8 characters at least.\"]"));
        String passwordAlertText = passwordAlert.getAttribute("content-desc");
        if(passwordAlertText.equals("Password must be 8 characters at least."))
        {
