...
public class confirmEmailUnmatched {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        confirmEmail.click();
        confirmEmail.sendKeys("reemyasser803@gmail.com");
        // First Name Empty
        ...
        // Email doesn't match
        WebElement emailAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"email must be the same\"]"));
        String emailAlertText = emailAlert.getAttribute("content-desc");
        if(emailAlertText.equals("email must be the same"))
        {
        ...
        // Password required
        WebElement passwordAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Password is required.\"]"));
        String passwordAlertText = passwordAlert.getAttribute("content-desc");
        if(passwordAlertText.equals("Password is required."))
        {
