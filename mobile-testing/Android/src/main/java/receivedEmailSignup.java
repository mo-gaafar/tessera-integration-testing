...
public class receivedEmailSignup {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        confirmEmail.click();
        confirmEmail.sendKeys("rosa.rehab25@gmail.com");
        ...
        password.click();
        password.sendKeys("rosa@Rehab1122");
        Thread.sleep(3000);
        ...
        WebElement sentLink = driver.findElement(By.xpath("//android.view.View[@content-desc=\"We sent a link to rosa.rehab25@gmail.com to verify your account.\"]"));
        String sentLinkText = sentLink.getAttribute("content-desc");
        if(sentLinkText.equals("We sent a link to rosa.rehab25@gmail.com to verify your account."))
        {
            System.out.println("Email Verification Passed");
        }
        else
        ...
        Thread.sleep(3000);
        WebElement passwordLogin = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.EditText"));
