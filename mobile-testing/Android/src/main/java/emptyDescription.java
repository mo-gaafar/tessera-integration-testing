...
public class emptyDescription {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        addEventTitleInput.sendKeys("Violets are blue");
        ...
        WebElement myEventStart = driver.findElement(By.xpath("//android.view.View[@content-desc=\"13, Saturday, May 13, 2023\"]"));
        myEventStart.click();
        Thread.sleep(3000);
        ...
        WebElement myEventEnd = driver.findElement(By.xpath("//android.view.View[@content-desc=\"14, Sunday, May 14, 2023\"]"));
        myEventEnd.click();
        Thread.sleep(3000);
