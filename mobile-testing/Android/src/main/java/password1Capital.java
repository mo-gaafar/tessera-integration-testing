...
public class password1Capital {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // Password minimum 1 uppercase character
        Thread.sleep(5000);
        WebElement passwordAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Must contain minimum of 1 uppercase character.\"]"));
        String passwordAlertText = passwordAlert.getAttribute("content-desc");
        if(passwordAlertText.equals("Must contain minimum of 1 uppercase character."))
        {
