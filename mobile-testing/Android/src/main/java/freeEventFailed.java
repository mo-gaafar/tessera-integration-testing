...
public class freeEventFailed {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        // fname required
        WebElement fnameAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Please enter your first name\"]"));
        String fnameAlertText = fnameAlert.getAttribute("content-desc");
        if(fnameAlertText.equals("Please enter your first name"))
        {
        ...
        // lname required
        WebElement lnameAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Please enter your last name\"]"));
        String lnameAlertText = lnameAlert.getAttribute("content-desc");
        if(lnameAlertText.equals("Please enter your last name"))
        {
