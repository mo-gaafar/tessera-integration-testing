...
public class forgotPassword {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(3000);
        WebElement checkEmail = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Check your email to update your password.\"]"));
        String checkEmailText = checkEmail.getAttribute("content-desc");
        if(checkEmailText.equals("Check your email to update your password."))
        {
            System.out.println("Forgot Password Passed");
        }
        else
