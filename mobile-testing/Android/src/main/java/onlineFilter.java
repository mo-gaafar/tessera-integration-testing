...
public class onlineFilter {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        WebElement onlineFilter = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Online\"]"));
        onlineFilter.click();

        // first event after online filter
        Thread.sleep(6000);
        WebElement firstEventFiltered = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Anime North 2023\n" +
                "Online\n" +
                "24  DEC\"]"));
        String firstEventFilteredText = firstEventFiltered.getAttribute("content-desc");
        if(firstEventFilteredText.equals("Anime North 2023\n" +
                "Online\n" +
                "24  DEC"))
        {
            System.out.println("Online Filter Passed");
        }
        else
        {
            System.out.println("Online Filter Failed");
        }
