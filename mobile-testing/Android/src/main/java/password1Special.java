...
public class password1Special {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(5000);
        WebElement passwordAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Must contain minimum of 1 special character.\"]"));
        String passwordAlertText = passwordAlert.getAttribute("content-desc");
        if(passwordAlertText.equals("Must contain minimum of 1 special character."))
        {
