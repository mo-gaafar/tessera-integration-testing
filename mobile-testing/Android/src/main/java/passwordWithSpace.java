...
public class passwordWithSpace {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(3000);
        WebElement passwordAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"Password must have at least 8 characters.\"]"));
        String passwordAlertText = passwordAlert.getAttribute("content-desc");
        if(passwordAlertText.equals("Password must have at least 8 characters.")) // should check for spaces
        {
