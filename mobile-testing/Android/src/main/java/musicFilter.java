...
public class musicFilter {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        Thread.sleep(5000);
        WebElement musicFilter = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Music\"]"));
        musicFilter.click();

        // first event after music filter
        Thread.sleep(6000);
        WebElement firstEventFiltered = driver.findElement(By.xpath("//android.widget.ImageView[@content-desc=\"Tessseraaaaaa\n" +
                "My Venue\n" +
                "1  MAY\"]"));
        String firstEventFilteredText = firstEventFiltered.getAttribute("content-desc");
        if(firstEventFilteredText.equals("Tessseraaaaaa\n" +
                "My Venue\n" +
                "1  MAY"))
        {
            System.out.println("Music Filter Passed");
        }
        else
        {
            System.out.println("Music Filter Failed");
        }
