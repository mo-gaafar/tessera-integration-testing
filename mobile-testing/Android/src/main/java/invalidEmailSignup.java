...
public class invalidEmailSignup {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        emailInput.click();
        emailInput.sendKeys("reem_s email");
        WebElement nextButton = driver.findElement(By.xpath("//android.widget.Button[@content-desc=\"Next\"]"));
        nextButton.click();
        WebElement emailAlert = driver.findElement(By.xpath("//android.view.View[@content-desc=\"This is not a valid email.\"]"));
        String emailAlertText = emailAlert.getAttribute("content-desc");
        if(emailAlertText.equals("This is not a valid email."))
        {
