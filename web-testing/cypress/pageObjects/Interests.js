class intersts {
  ...
  Tickets =
    "div[class='consumer-header__links'] div:nth-child(2) a:nth-child(1)";
  ...
  Alternativebtn =
    ":nth-child(1) > .interest-panel__card > .eds-card > .interest-panel__card-contents > :nth-child(2) > .eds-tag";
  ":nth-child(1) > .interest-panel__card > .eds-card > .interest-panel__card-contents > :nth-child(4) > .eds-tag > .eds-tag__text";
  Location = "#locationPicker";

  NEXT =
    "button[class='eds-btn eds-btn--button eds-btn--fill eds-btn--responsive']";
  FollowPage = ".eds-text-hl";
  ...
  clicksubmit() {
    ...
    cy.get(
      "div[data-spec='consumer-header-user-menu'] a[aria-label='Menu dropdown link']"
    )
      .invoke("show")
      .should("be.visible")
      .trigger("mouseover");
