class Login {
  ...
  eventbriteLogo = ".eds-l-mar-bot-6.eds-fx--pop.eds-fx--delay-1.authentication__page-header__icon"; // or svg ??
  ...
  emptyPasswordMsg = '.eds-password--v2 > [data-testid="input-field-wrapper"] > .eds-field__sub > .eds-field__sub--left > .eds-field-styled__annotation';
  emptyEmailMsg = 'form > :nth-child(1) > [data-testid="input-field-wrapper"] > .eds-field__sub > .eds-field__sub--left > .eds-field-styled__annotation';
